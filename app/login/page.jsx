    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-lg mt-8">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Hi <span className="font-semibold text-black">{user.display_name}</span>, we're glad to see you 👋
          </p>
          <p className="text-sm text-gray-500">
            You're now logged in. Explore the options available to manage your content and settings.
          </p>
        </div>

        {/* Redirect Section */}
        <div className="mt-6 text-center">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Ready to explore?</h2>
